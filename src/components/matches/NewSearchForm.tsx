  ...
  return (
    <Card className="gap-3">
      ...
      <textarea
        ...
        className="rounded-radius-sm border-card-border text-foreground focus:border-accent w-full border bg-white/8 shadow-sm px-3 py-2 text-sm outline-none disabled:opacity-60"
      />
