  ...
  return (
    <Card className="gap-3">
      ...
      <textarea
        ...
        className="rounded-radius-sm border-card-border text-foreground focus:border-accent w-full border bg-white/8 px-3 py-2 text-sm shadow-sm outline-none disabled:opacity-60"
      />
