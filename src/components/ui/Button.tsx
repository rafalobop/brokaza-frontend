...
export function Button({
  ...
  return (
    <button
      {...props}
      className={`rounded-radius-sm font-semibold transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-50 ${VARIANT_CLASSES[variant]} ${SIZE_CLASSES[size]} ${className}`}
    />
  );
}
